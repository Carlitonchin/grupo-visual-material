...
export default async function Parabens() {
  const slides = await getHomeMains();
  return (
    <section
      style={{
        backgroundColor: "#023457",
        backgroundImage: `url("${slides[0].imgMobile}")`,
        backgroundPosition: "center",
        backgroundSize: "cover",
      }}
      className="h-screen text-white text-center min-h-[500px] flex flex-col items-center justify-center pt-52 md:pt-32"
    >
      <svg
        viewBox="0 0 128 128"
        aria-hidden="true"
        role="img"
        className="iconify iconify--noto w-40 h-40 mt-4"
      ...
      <HeaderText variant="h1" font="Custom" className="max-w-[600px] mb-4">
        Parabens pela sua compra
      </HeaderText>
      <HeaderText
        variant="h2"
        font="Custom"
        className="max-w-[600px] text-lg mb-4"
      >
        Agradecemos por confiar em Grupo Visual. Em breve, entraremos em contato
        para orientá-lo(a) nos próximos passos.
      </HeaderText>
      <TextLink
