    ...
    <div className="item-carousel-3 inline-block relative ">
      <a href="/">
        ...
        >
          ...
          <div className="w-full h-3/5 p-4 text-center relative">
            <MKTypography
            ...
            >
              Um novo metodo de ensino testado na Europa esta causando furor
              entre varias das melhores universidades do continente. Os
              estudantes tem acrescentado num 35% suas notas Um novo metodo de
              ensino testado..
            </MKTypography>
